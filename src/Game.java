...
public class Game {
	...
	public static void main(String[] args) {
		String test = JOptionPane.showInputDialog("Do you want to play in developer mode (you can see the secret code when playing. (Y/N):");
		while (test == null || (test.equals("Y") || test.equals("N")) == false)
		{
			if(test == null) test = JOptionPane.showInputDialog("Do you want to play in developer mode (you can see the secret code when playing. (Y/N):");
			else
			{
				test = JOptionPane.showInputDialog("Invalid input. Please enter again(Y/N): ");
			}
		}
...
//ask customization
		System.out.println(
				"Do you want to customize the number of maximum guesses and the number of holes per row? If not, the default values are 12 and 4. (Y/N):");
...
//		}
		...
		while (num_guesses_left > 0) {
			...
			if (testmode == true)
				System.out.println(gameboard.codeString);
